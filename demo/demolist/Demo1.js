    ...
    render () {
        ...
        return (
            <div className="demoPadding demo1">
                ...
                <Drawer  showClose={true} hasHeader={true} zIndex={3333} showMask={true} maskClosable={false} title={title} show={showDrawer} placement={placement} onClose={this.fCloseDrawer}>
                    <div className="con">
